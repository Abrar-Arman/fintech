# CostForge — Django REST Framework backend

This is the server side of CostForge, the AI-agent budget predictor.
...
The React frontend lives in `artifacts/costforge/` and currently runs
...
The Replit workflow `CostForge Django API` runs `migrate` + `seed` +
